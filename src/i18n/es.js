...
export default {
  ...
  blog: {
    ...
    posts: [
      {
        ...
        devToUrl: 'https://dev.to/marilau-tech/ego-del-desarrollador-y-por-que-regularlo-te-hara-mejor-profesional-k2p',
      ...
      },
      {
        ...
        devToUrl: 'https://dev.to/marilau-tech/la-habilidad-mas-infravalorada-del-mundo-profesional-dar-y-recibir-mentoria-5dmh',
    ...
    commentTitle: '¿Tienes algo que aportar?',
    commentText:  'Los comentarios están abiertos en dev.to. Me encantaría leer lo que piensas.',
    commentCta:   'Ir a comentar en dev.to →',
  },
