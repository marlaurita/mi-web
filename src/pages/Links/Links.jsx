...
const LINKS = [
  ...
  {
    id: 'mentoria',
    label: 'Agenda una mentoría',
    href: 'https://marilau.tech/#mentoring',
    highlight: true,
  },
]
...
const SOCIALS = [
  {
    id: 'linkedin',
    href: 'https://linkedin.com/in/marilautech',
    label: 'LinkedIn',
    icon: (
  ...
  {
    id: 'instagram',
    href: 'https://instagram.com/marilau.tech',
    label: 'Instagram',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
  ...
  {
    id: 'github',
    href: 'https://github.com/marlaurita',
    label: 'GitHub',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
        ...
        <div className="links-list">
          {LINKS.map((link) => (
            ...
            >
              ...
              <ExternalLink size={16} className="links-card-icon" />
            </a>
          ))}
        </div>
